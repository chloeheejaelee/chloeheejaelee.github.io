...
<html>
	<head>
		<title></title>
			...
			<link href="https://fonts.googleapis.com/css2?family=Ephesis&family=Playfair+Display&display=swap" rel="stylesheet">
		<style>
			.left {
				width: 5%;
				display: block;
	...
	<body>
		...
		<div class="section">
			...
			<h1>Chloe's Blog</h1>
			<a href="https://www.youtube.com/watch?v=aNLJ04DtgTA" target="_blank"><img src="V2.gif" class="star"></a>
		</div>
	</body>
</html>